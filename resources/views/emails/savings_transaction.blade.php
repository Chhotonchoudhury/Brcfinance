...
<head>
    <title>Account Transaction Update</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <h1>{{ $savingsAccount->member->first_name }} {{ $savingsAccount->member->middle_name ?? '' }} {{
                $savingsAccount->member->last_name }}</h1>

            <p>Your recent <strong>Savings account {{ $transaction->action_type == 'deposit' ? 'deposit' : 'withdrawal
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="{{ $transaction->action_type == 'deposit' ? 'success' : 'danger' }}">
                        <span class="icon">
                ...
                <tr>
                    ...
                    <td class="{{ $transaction->action_type == 'deposit' ? 'success' : 'danger' }}">
                        ...
                        @else
                        &#45;
                        @endif ₹{{ number_format($transaction->amount,
                        2) }}
                    </td>
                </tr>
                <tr>
                    <th>Current Account Balance</th>
                    <td class="{{ $savingsAccount->balance >= 0 ? 'success' : 'danger' }}">
