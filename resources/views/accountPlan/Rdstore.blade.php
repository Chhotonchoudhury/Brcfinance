@extends('layouts/app')
@section('title') RD Account Plan Store @endsection
...
<div class="row gutters mb-2">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('rd.index') }}" class="btn btn-sm btn-outline-dark py-1 px-2"
...
<div class="card">
    <form action="{{ route('rd.save', $plan->id ?? '') }}" id="DDstore" method="POST">
        @csrf
        ...
        <div class="card-body">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                <div class="form-section-header">@if(isset($plan->id)) Update @else Add @endif RD Plan Details</div>
            </div>
