...
@section('title') RD Account Plans @endsection
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    @if(hasRolePermission('rdPlans-create'))
                    <a href="{{ route('rd.form') }}" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="{{ route('rd.index') }}" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            @if(hasRolePermission('rdPlans-data-export'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(hasRolePermission('rdPlans-edit'))
                                        <!-- Edit Button (Pencil Icon) -->
                                        <a href="{{ route('rd.form', $ddPlan->id) }}" class="icon green"
