...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top top-0 ">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="{{ asset($companyLogo) }}" alt="Logo"></a>
            ...
            <div class="collapse navbar-collapse d-none d-lg-flex">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link {{ Request::is('accounts') ? 'active' : '' }}"
                            href="/accounts">Accounts</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Contact</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('frontend.test1') }}">ProtoType</a></li>

                    <!-- Download App Button -->
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-danger text-white" href="{{ asset('AndriodApp.apk') }}"
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="/accounts" class="{{ Request::is('accounts') ? 'active' : '' }}">Accounts</a></li>
            <li><a href="#">Contact</a></li>
            <li><a href="{{ route('login') }}">Login</a></li>
            <li><a href="{{ route('frontend.test1') }}">ProtoType</a></li>
            <!-- Sidebar Download Button -->
            <div class="download-app">
                <a href="{{ asset('AndriodApp.apk') }}" class="btn btn-outline-success text-white download-btn"
