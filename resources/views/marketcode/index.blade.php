...
@section('title') Market Code @endsection
        ...
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    ...
                    <a href="{{ route('marketcode.form') }}" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="{{ route('marketcode.index') }}" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            @if(hasRolePermission('marketCodes-data-export'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(hasRolePermission('marketCodes-edit'))
                                        <!-- Edit Button (Pencil Icon) -->
                                        <a href="{{ route('marketcode.form', $code->id) }}" class="icon green"
