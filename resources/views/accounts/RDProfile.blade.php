...
@section('title') RD Account Profile @endsection
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card mb-1">
            <div class="account-type d-flex justify-content-between">
                RD Account
                <a href="{{ route('rdAc.account') }}" class=""><span class="icon-arrow-left-circle"></span>Back</a>
            </div>
            <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="first" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table-custom">
                                    ...
                                    <tr>
                                        <th>Plan</th>
                                        <td>{{$account->rdPlan->plan_name }} | {{$account->rdPlan->plan_code
                                            }}
                                        </td>

                                        <th>Interest Rate</th>
                                        <td>{{$account->rdPlan->annual_interest_rate }} %</td>
                                    </tr>

                                    <tr>
                                        <th>Tenure</th>
                                        <td>{{$account->rdPlan->tenure_value }} | {{$account->rdPlan->tenure_type
                                            }}
                                        </td>

                                        <th>RD (DD frequency)</th>
                                        <td>{{$account->rdPlan->rd_dd_frequency }}</td>
                                    </tr>

                                    <tr>
                                        <th>Min Amount</th>
                                        <td>{{$account->rdPlan->minimum_amount }}
                                        </td>

                                        <th>Interest Compounding</th>
                                        <td>{{$account->rdPlan->interest_compounding_interval }}</td>
                                    </tr>
                                    <tr>
                                        <th>Ac on Hold</th>
