            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="{{ route('rdAc.pending') }}" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            @if(hasRolePermission('pendingrdAC-data-export'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        @if(hasRolePermission('pendingrdAC-approve'))
                                        @if ($account->status === 'pending' || $account->status === 'rejected')
                                        <form action="{{ route('rd.updateStatus', $account->id) }}" method="POST"
                                        ...
                                        @if(hasRolePermission('pendingrdAC-reject'))
