@extends('layouts/app')
@section('title') Savings Account Create @endsection
...
<div class="row gutters mb-2">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('sa.index') }}" class="btn btn-sm btn-outline-dark py-1 px-2"
...
<div class="card">
    ...
    <form action="{{ route('sa.store') }}" id="SAstore" method="POST">
        @csrf
        ...
        <div class="card-body">
            <div class="row gutters">
                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="field-wrapper">
                            <select class="select-single js-states @error('savings_plan_id') is-invalid @enderror"
                                name="savings_plan_id" id="savingsPlanSelect">
                                <option selected>Select Plan</option>
                                @foreach($savingsPlans as $plan)
                                <option value="{{ $plan->id }}" {{ old('savings_plan_id')==$plan->id ? 'selected' :
                                    ''
                                    }}>
