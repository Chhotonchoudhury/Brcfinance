...
<body>
    ...
    <div class="container">
        ...
        <!-- Email Content -->
        <div class="content">
            <h1>Dear <?php echo e($savingsAccount->member->first_name); ?> <?php echo e($savingsAccount->member->middle_name ?? ''); ?> <?php echo e($savingsAccount->member->last_name); ?>,</h1>

            <p>We are pleased to inform you that your <strong>RD account</strong> has been successfully created.
            </p>
            ...
            <table class="details-table">
                ...
                <tr>
                    <th>Branch</th>
                    <td><?php echo e($savingsAccount->branch->branch_name); ?></td>
                </tr>
                <tr>
                    <th>Opening Date</th>
                    <td><?php echo e($savingsAccount->opeaning_date); ?></td>
                </tr>
                <tr>
                    <th>Initial Deposit</th>
                    <td>₹<?php echo e(number_format($savingsAccount->balance, 2)); ?></td>
                </tr>
                <tr>
                    <th>Account Status</th>
                    <td><?php echo e($savingsAccount->account_status); ?></td>
                </tr>
            </table>
...
</html><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/emails/rd_account_created.blade.php ENDPATH**/ ?>