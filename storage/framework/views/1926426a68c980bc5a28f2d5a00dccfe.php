...
<?php $__env->startSection('title'); ?> Loan Agains Deposit Plans <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <?php if(hasRolePermission('loanADPlans-create')): ?>
                    <a href="<?php echo e(route('loanAD.form')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('loanAD.index')); ?>" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            <?php if(hasRolePermission('loanADPlans-data-export')): ?>
                    ...
                    <table id="plan-table" class="table table-bordered table-striped table-hover v-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($plan->deposit_type); ?></td>
                                <td><?php echo e($plan->max_loan_amount); ?></td>
                                <td><?php echo e($plan->interest_rate); ?>%</td>
                                <td><?php echo e($plan->tenure_months); ?></td>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <?php if(hasRolePermission('loanADPlans-edit')): ?>
                                        <!-- Edit Button (Pencil Icon) -->
                                        <a href="<?php echo e(route('loanAD.form', $plan->id)); ?>" class="icon green"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accountPlan/LoanADindex.blade.php ENDPATH**/ ?>