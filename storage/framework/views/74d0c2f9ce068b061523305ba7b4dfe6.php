    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <a href="<?php echo e(route('agent.form')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('agent.index')); ?>" class="d-flex align-items-center">
                    ...
                    <table id="agent-table" class="table table-bordered table-striped table-hover v-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($agent->agent_code ?? 'N/A'); ?></td>
                                <td><?php echo e($agent->name); ?></td>
                                <td><?php echo e($agent->email); ?></td>
                                <td><?php echo e($agent->phone); ?></td>
                                <td><?php echo e($agent->branch->branch_name ?? 'N/A'); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($agent->joining_date)->format('d-m-Y')); ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <a href="<?php echo e(route('agent.form', $agent->id)); ?>" class="icon green"
            ...
            <div class="card-footer" style="padding: 1%">
                ...
                <div class="footer-info">
                    Total Records : <?php echo e($agents->total()); ?>

                </div>

                <!-- Pagination -->
                <div class="pagination-container">
                    <?php echo e($agents->links('vendor.pagination.custom-pagination')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/agents/list.blade.php ENDPATH**/ ?>