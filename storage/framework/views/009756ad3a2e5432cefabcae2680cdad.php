        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-9">
            ...
            <div class="search-container">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="logo">
                    <img src="<?php echo e(asset($companyLogo)); ?>" alt="Uni Pro Admin Dashboard">
                </a>
                <!-- Logo end -->

                <!-- Mega Menu Start -->
                <div class="cd-dropdown-wrapper">
                    <a class="cd-dropdown-trigger" href="#0"><i class="fas fa-bars me-1"></i><span
            ...
            <ul class="header-actions">
                ...
                <li class="dropdown">
                    <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                        <span class="avatar">
                            <img src="<?php echo e(asset('assetsDashboard/img/user.svg')); ?>" alt="User Avatar">
                            <span class="status busy"></span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end md" aria-labelledby="userSettings">
                        <div class="header-profile-actions">
                            <a href="user-profile.html"><i class="fas fa-user"></i><?php echo e(auth()->user()->name); ?></a>
...
<!-- Page header ends --><?php /**PATH C:\xampp\htdocs\NidhiBank\resources\views/layouts/header.blade.php ENDPATH**/ ?>