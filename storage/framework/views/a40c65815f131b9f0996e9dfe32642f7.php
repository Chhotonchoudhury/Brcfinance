...
<?php $__env->startSection('title'); ?> RD Account Create <?php $__env->stopSection(); ?>
...
<div class="row gutters mb-2">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('rdAc.account')); ?>" class="btn btn-sm btn-outline-dark py-1 px-2"
...
<div class="card">
    ...
    <form action="<?php echo e(route('rdAc.store')); ?>" id="SAstore" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $rdPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                        <div class="field-wrapper d-flex align-items-center">
                            ...
                            <label class="form-switch">
                                ...
                                <input type="checkbox" name="tds" id="tds" value="1" <?php echo e(old('tds') ? 'checked' : ''); ?>>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                        <div class="field-wrapper d-flex align-items-center">
                            ...
                            <label class="form-switch">
                                ...
                                <input type="checkbox" name="renew" id="renew" value="1" <?php echo e(old('renew') ? 'checked'
                                    : ''); ?>>
                                <span class="form-switch-slider"></span>
                                <!-- Sends 0 when unchecked -->
                            </label>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                        <div class="field-wrapper d-flex align-items-center">
                            ...
                            <label class="form-switch">
                                ...
                                <input type="checkbox" name="st" id="st" value="1" <?php echo e(old('st') ? 'checked' : ''); ?>>
                                <span class="form-switch-slider"></span>
                                <!-- Sends 0 when unchecked -->
                            </label>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accounts/RdAcForm.blade.php ENDPATH**/ ?>