<?php $__env->startSection('title'); ?> Agent Store <?php $__env->stopSection(); ?>
...
<div class="row gutters mb-2">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('agent.index')); ?>" class="btn btn-sm btn-outline-dark py-1 px-2"
...
<div class="card">
    <form action="<?php echo e(route('agent.save', $agent->id ?? '')); ?>" id="store" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>

        <div class="card-body">

            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                <div class="form-section-header"><?php if(isset($agent->id)): ?> Update <?php endif; ?> General info</div>
            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="field-wrapper">
                        <div class="input-group">
                            <select class="form-select js-states select2 <?php $__errorArgs = ['branch_id'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="" <?php echo e(old('branch_id', $agent->branch_id ?? '') == '' ? 'selected' :
                                    ''); ?>>Select Branch</option>
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>" <?php echo e(old('branch_id', $agent->branch_id ?? '') ==
                                    $branch->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" type="date"
                                name="joining_date"
                                value="<?php echo e(old('joining_date',   isset($agent) && $agent->joining_date ? $agent->joining_date->format('Y-m-d') : '')); ?>"
                                required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" type="text" name="phone"
                                value="<?php echo e(old('phone', $agent->phone ?? '')); ?>" required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" name="gender" required>
                                <option value="" <?php echo e(old('gender', $agent->gender ?? '') == '' ? 'selected' : ''); ?>>Select Gender</option>
                                <option value="Male" <?php echo e(old('gender', $agent->gender ?? '') == 'Male' ? 'selected' :
                                    ''); ?>>Male</option>
                                <option value="Female" <?php echo e(old('gender', $agent->gender ?? '') == 'Female' ?
                                    'selected' : ''); ?>>Female</option>
                                <option value="Other" <?php echo e(old('gender', $agent->gender ?? '') == 'Other' ? 'selected'
                                    : ''); ?>>Other</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>" type="date"
                                name="date_of_birth"
                                value="<?php echo e(old('date_of_birth', isset($agent) && $agent->date_of_birth ? $agent->date_of_birth->format('Y-m-d') : '')); ?>"
                                required>
                            <span class="input-group-text">
                                <i class="icon-calendar"></i>
                            </span>
...
unset($__errorArgs, $__bag); ?>" name="is_active"
                                required>
                                <option value="1" <?php echo e(old('is_active', $agent->is_active ?? 1) == 1 ? 'selected' : ''); ?>>Active</option>
                                <option value="0" <?php echo e(old('is_active', $agent->is_active ?? 1) == 0 ? 'selected' : ''); ?>>Inactive</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Row end -->
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                <div class="form-section-header"><?php if(isset($agent->id)): ?> Update <?php endif; ?> Proof & Details</div>
            </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="aadhaar_number" value="<?php echo e(old('aadhaar_number', $agent->aadhaar_number ?? '')); ?>"
                                required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="pan_number" value="<?php echo e(old('pan_number', $agent->pan_number ?? '')); ?>" required>
                            <span class="input-group-text">
                                <i class="icon-credit-card"></i>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row gutters">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="field-wrapper">
                        <div class="input-group">
                            <input class="form-control <?php $__errorArgs = ['commission_rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="number"
                                ...
                                value="<?php echo e(old('commission_rate', $agent->commission_rate ?? '')); ?>" required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" type="text" name="city"
                                value="<?php echo e(old('city', $agent->city ?? '')); ?>" required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" type="text" name="state"
                                value="<?php echo e(old('state', $agent->state ?? '')); ?>" required>
                            <span class="input-group-text">
                                <i class="icon-location"></i>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="address" value="<?php echo e(old('address', $agent->address ?? '')); ?>" required>
                            <span class="input-group-text">
                                <i class="icon-location"></i>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Row end -->
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                <div class="form-section-header"><?php if(isset($agent->id)): ?> Update <?php endif; ?> Bank Details</div>
            </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="bank_name" value="<?php echo e(old('bank_name', $agent->bank_name ?? '')); ?>" required>
                            <span class="input-group-text">
                                <i class="icon-bank"></i>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="account_number" value="<?php echo e(old('account_number', $agent->account_number ?? '')); ?>"
                                required>
                            <span class="input-group-text">
                                <i class="icon-credit-card"></i>
                            </span>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="ifsc_code" value="<?php echo e(old('ifsc_code', $agent->ifsc_code ?? '')); ?>" required>
                            <span class="input-group-text">
                                <i class="icon-code"></i>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="branch_name" value="<?php echo e(old('branch_name', $agent->branch_name ?? '')); ?>" required>
                            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer d-flex justify-content-end">
            <button class="btn btn-sm btn-outline-primary py-1 px-2" id="submitButton" type="submit">
                ...
                <span id="buttonText"><?php if(isset($agent->id)): ?> Update <?php else: ?> Submit <?php endif; ?> </span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/agents/storeFrom.blade.php ENDPATH**/ ?>