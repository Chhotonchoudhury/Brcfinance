...
<?php $__env->startSection('title'); ?> Deposit Blance <?php $__env->stopSection(); ?>
...
<div class="row gutters mb-2">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Savings Account</a></li>
                <li class="breadcrumb-item active" aria-current="page">Deposit / Withdrawal</li>
                    ...
                    <div class="row g-2 ">
                        <div class="col-md-9">
                            <input type="text" id="account_search" class="form-control form-control-lg"
                                placeholder="Enter Savings Account Number" aria-label="Account Number Search">
                        </div>
                        <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>" type="number"
                                    id="amount" name="amount" value="<?php echo e(old('amount')); ?>" placeholder="Enter Amount"
                                    required>
...
unset($__errorArgs, $__bag); ?>" type="date"
                                    name="transaction_date" value="<?php echo e(old('transaction_date')); ?>" required>
...
<script>
    ...
    document.getElementById('searchButton').addEventListener('click', function () {
        ...
        fetch(`/get-SA/search?account_number=${accountNumber}`)
            .then(response => {
                if (!response.ok) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accounts/DepositBlnc.blade.php ENDPATH**/ ?>