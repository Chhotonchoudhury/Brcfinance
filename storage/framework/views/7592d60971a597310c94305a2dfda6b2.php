...
<?php $__env->startSection('title'); ?> Loan Against Deposit <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <a href="<?php echo e(route('LoanADApplication.create')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('LoanADApplication.index')); ?>"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($account->application_number); ?></td>
                                <td><?php echo e($account->member->member_code); ?> <br>(<?php echo e($account->member->first_name); ?> <?php echo e($account->member->last_name); ?>)</td>
                                <td><?php echo e($account->branch->branch_name); ?></td>
                                <td>
                                    <?php echo e($account->marketcode ? $account->marketcode->code . ' - ' .
                                    $account->marketcode->area_name : 'N/A'); ?>

                                </td>

                                <td>
                                    Type: <?php echo e($account->against_type); ?><br>
                                    Ac: <?php echo e($account->against_account_number ?? 'N/A'); ?>

                                </td>

                                <td>₹ <?php echo e(number_format($account->application_balance, 2)); ?></td>
                                <td><?php echo e($account->application_date); ?></td>
                                <td><?php echo e($account->associated ? $account->associated->name . '-' .
                                    $account->associated->user_type : 'NA'); ?></td>
                                <td><?php echo e($account->applicant->name ?? 'NA'); ?></td>



                                <td><span
                                        class="badge bg-<?php echo e($account->application_status == 'approved' ? 'success' : ($account->application_status == 'pending' ? 'warning' : 'danger')); ?>"><?php echo e(ucfirst($account->application_status)); ?></span></td>

                                <td>
                                    <?php if($account->application_approved_by && $account->application_approved_at): ?>
                                    <?php echo e($account->applicationApprovedBy->name); ?><br>
                                    <?php echo e(\Carbon\Carbon::parse($account->application_approved_at)->format('d-m-Y')); ?>
                                ...
                                <td>
                                    <?php if($account->application_rejected_by && $account->application_rejected_at): ?>
                                    <?php echo e($account->applicationRejectedBy->name); ?><br>
                                    <?php echo e(\Carbon\Carbon::parse($account->application_rejected_at)->format('d-m-Y')); ?>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <a href="#" class="icon text-primary" data-bs-toggle="tooltip"
                                            ...
                                            title="<?php echo e($account->application_approved_by == null ? 'Approve Application' : 'Quick View'); ?>"
                                            onclick="openLoanModal(<?php echo e($account->id); ?>)">
                                            <i
                                                class="fas <?php echo e($account->application_approved_by == null ? 'fa-check-circle' : 'fa-eye'); ?>"></i>
                                        </a>


                                        <!-- Show delete button if not yet approved -->
                                        <?php if($account->application_approved_by == null): ?>
                                        <!-- Delete Button (Trash Icon) -->
                                        <form action="<?php echo e(route('LoanADApplication.delete', $account->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accounts/LoanAdApplication.blade.php ENDPATH**/ ?>