    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <?php if(hasRolePermission('employee-create')): ?>
                    <a href="<?php echo e(route('employees.form')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('employees.index')); ?>" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            <?php if(hasRolePermission('employee-data-export')): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <?php if(hasRolePermission('employee-profile-view')): ?>
                                        <a href="#" class="icon blue" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="View" data-bs-original-title="View Row">
                                            <i class="icon-eye"></i>
                                        </a>
                                        <?php endif; ?>
                                        <!-- Appointment Letter Download Button -->
                                        <?php if(hasRolePermission('employee-export-appointment')): ?>
                                        <a href="<?php echo e(route('employees.letter.download', $employee->id)); ?>"
                                            class="icon text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Download Appointment Letter"
                                            data-bs-original-title="Download Appointment Letter">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php if(hasRolePermission('employee-edit')): ?>
                                            <a href="<?php echo e(route('employees.form', $employee->id)); ?>" class="icon green"
            ...
            <div class="card-footer" style="padding: 1%">
                ...
                <div class="footer-info">
                    Total Records : <?php echo e($employees->total()); ?>

                </div>

                <!-- Pagination -->
                <div class="pagination-container">
                    <?php echo e($employees->links('vendor.pagination.custom-pagination')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/employees/list.blade.php ENDPATH**/ ?>