...
<?php $__env->startSection('title'); ?> RD Account Profile <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card mb-1">
            <div class="account-type d-flex justify-content-between">
                RD Account
                <a href="<?php echo e(route('rdAc.account')); ?>" class=""><span class="icon-arrow-left-circle"></span>Back</a>
            </div>
            <div class="card-body">
                ...
                <div class="custom-tabs-container">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="tran-tab" data-bs-toggle="tab" href="#tran" role="tab"
                                aria-controls="tran" aria-selected="false">Deposit Payment</a>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="first" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table-custom">
                                    ...
                                    <tr>
                                        <th>Plan</th>
                                        <td><?php echo e($account->rdPlan->plan_name); ?> | <?php echo e($account->rdPlan->plan_code); ?>

                                        </td>

                                        <th>Interest Rate</th>
                                        <td><?php echo e($account->rdPlan->annual_interest_rate); ?> %</td>
                                    </tr>

                                    <tr>
                                        <th>Tenure</th>
                                        <td><?php echo e($account->rdPlan->tenure_value); ?> | <?php echo e($account->rdPlan->tenure_type); ?>

                                        </td>

                                        <th>RD (DD frequency)</th>
                                        <td><?php echo e($account->rdPlan->rd_dd_frequency); ?></td>
                                    </tr>

                                    <tr>
                                        <th>Min Amount</th>
                                        <td><?php echo e($account->rdPlan->minimum_amount); ?>

                                        </td>

                                        <th>Interest Compounding</th>
                                        <td><?php echo e($account->rdPlan->interest_compounding_interval); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Ac on Hold</th>
                        ...
                        <div class="tab-pane fade" id="tran" role="tabpanel">
                            <form id="SaTran" action="<?php echo e(route('rdAc.transaction')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="card">
                                    <!-- Payment Information Section -->
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                                        <div class="form-section-header">Make Deposit</div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accounts/RDProfile.blade.php ENDPATH**/ ?>