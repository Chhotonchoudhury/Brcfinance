                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end md" aria-labelledby="userSettings">
                        <div class="header-profile-actions">
                            <a href="user-profile.html"><i class="icon-user1"></i><?php echo e(auth()->user()->name); ?></a>
...
<!-- Page header ends --><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/layouts/header.blade.php ENDPATH**/ ?>