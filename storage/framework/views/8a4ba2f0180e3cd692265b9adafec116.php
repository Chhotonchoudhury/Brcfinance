                        ...
                        <ul>
                            <li>
                                <a href="<?php echo e(route('dashboard')); ?>" <?php if(request()->routeIs('dashboard')): ?>
                                    class="current-page" <?php endif; ?>><span class="icon-grid me-1"></span> Dashboard</a>
                            </li>
                           <?php if(hasRolePermission('company-view')): ?>
                            <li>
                                <a href="<?php echo e(route('company.view')); ?>" <?php if(request()->routeIs('company.view')): ?>
                                    class="current-page" <?php endif; ?>> <span class="icon-domain me-1"></span>
                                    Company</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('company.branch')); ?>" <?php if(request()->routeIs('company.branch')): ?>
                                    class="current-page" <?php endif; ?>><span class="icon-clear_all me-1"></span>
                                    Branches</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('sa.index')); ?>" <?php if(request()->routeIs('sa.index')): ?>
                                    class="current-page" <?php endif; ?>><span class=" me-2">₹</span> Saving Accounts</a>
                            </li>
                            <?php endif; ?>
                            <?php if(hasRolePermission('pendingSAC-list-view')): ?>
                            <li>
                                <a href="<?php echo e(route('sa.pending')); ?>" <?php if(request()->routeIs('sa.pending')): ?>
                                    class="current-page" <?php endif; ?>><span class=" me-2">?</span> Pending SA </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('rdAc.account')); ?>" <?php if(request()->routeIs('rdAc.account')): ?>
                                    class="current-page" <?php endif; ?>><span class=" me-2">₹</span> RD Accounts</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('rdAc.pending')); ?>" <?php if(request()->routeIs('rdAc.pending')): ?>
                                    class="current-page" <?php endif; ?>><span class=" me-2">?</span> Pending RD</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('member.index')); ?>" <?php if(request()->routeIs('member.index')): ?>
                                    class="current-page" <?php endif; ?>><span class="icon-users me-1"></span> Members</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('agent.index')); ?>" <?php if(request()->routeIs('agent.index')): ?>
                                    class="current-page" <?php endif; ?>><span class="icon-briefcase me-1"></span> Agents</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('employees.index')); ?>" <?php if(request()->routeIs('employees.index')): ?>
                                    class="current-page" <?php endif; ?>><span class="icon-user me-1"></span> Empolyees</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                       ...
                       <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('d.index')); ?>"
                                    ...
                                    <i class="fas fa-exchange-alt me-1"></i> Deposit / Withdrawal
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('rd.deposit.index')); ?>"
                                    class="<?php if(request()->routeIs('rd.deposit.index')): ?> current-page <?php endif; ?>"><i
                                        class="fas fa-calendar-check me-1"></i> RD
                                    Deposit</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('transaction.index')); ?>"
                                    class="<?php if(request()->routeIs('transaction.index')): ?> current-page <?php endif; ?>"> <i
                                        class="fa fa-exchange-alt me-1"></i> Transactions</a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('pending.transaction')); ?>"
                                    class="<?php if(request()->routeIs('pending.transaction')): ?> current-page <?php endif; ?>"><i
                                        class="fa fa-table me-1"></i> All Transactions</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('LoanADApplication.index')); ?>"
                                    ...
                                    <i class="fas fa-file-invoice-dollar me-1"></i> (LAD) Application
                                </a>
                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('marketcode.index')); ?>"
                                    ...
                                    <i class="fas fa-list me-2"></i> All Market Codes
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('rd-interest-slab.index')); ?>"
                                    ...
                                    <i class="fas fa-list me-2"></i> All RD Interest Slab
                                </a>
                            </li>
                            <?php endif; ?>
...
</script><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>