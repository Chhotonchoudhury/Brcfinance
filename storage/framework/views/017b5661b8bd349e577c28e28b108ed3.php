            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex">
                            <?php if(hasRolePermission('pendingsavingsAC-data-export')): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        <?php if(hasRolePermission('pendingSAC-approve')): ?>
                                        <?php if($account->status === 'pending' || $account->status === 'rejected'): ?>
                                        <form action="<?php echo e(route('sa.updateStatus', $account->id)); ?>" method="POST"
                                        ...
                                        <?php if(hasRolePermission('pendingSAC-reject')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accounts/SavingAcApproval.blade.php ENDPATH**/ ?>