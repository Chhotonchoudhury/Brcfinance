...
<?php $__env->startSection('title'); ?> Market Code <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                <div class="ms-2">
                    <h6 class="m-0">All Market codes</h6>
                </div>
                <div class="me-2">
                    <?php if(hasRolePermission('marketCodes-create')): ?>
                    <a href="<?php echo e(route('marketcode.form')); ?>" onclick="showLoadingEffect(event)"
                        class="btn btn-sm btn-outline-primary py-1 px-2">
                        <i class="icon-plus1"> </i> New MarketCode
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('marketcode.index')); ?>" class="d-flex align-items-center">
                        ...
                        <div class="d-flex">
                            <?php if(hasRolePermission('marketCodes-data-export')): ?>
                    ...
                    <table id="plan-table" class="table table-bordered table-striped table-hover v-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($code->code ?? 'N/A'); ?></td>
                                <td><?php echo e($code->area_name); ?></td>
                                <td><?php echo e($code->pincode); ?></td>
                                <td>
                                    <?php if($code->status): ?>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <?php if(hasRolePermission('marketCodes-edit')): ?>
                                        <!-- Edit Button (Pencil Icon) -->
                                        <a href="<?php echo e(route('marketcode.form', $code->id)); ?>" class="icon green"
                            ...
                            <tr>
                                <td colspan="15" class="text-center">No marlet code found.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/marketcode/index.blade.php ENDPATH**/ ?>