<?php $__env->startSection('title'); ?> Saving Account Plans <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <?php if(hasRolePermission('savingsPlans-create')): ?>
                    <a href="<?php echo e(route('saving.form')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('saving.index')); ?>" class="d-flex align-items-center">
                    ...
                    <table id="plan-table" class="table table-bordered table-striped table-hover v-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($plan->plan_code ?? 'N/A'); ?></td>
                                <td><?php echo e($plan->plan_name); ?></td>
                                <td><?php echo e(number_format($plan->min_opening_balance, 2)); ?></td>
                                <td><?php echo e($plan->annual_interest_rate); ?>%</td>
                                <td><?php echo e($plan->interest_payout); ?></td>
                                <td><?php echo e(number_format($plan->lock_in_amount, 2)); ?></td>
                                <td><?php echo e(number_format($plan->min_monthly_avg_balance_charge, 2)); ?></td>
                                <td><?php echo e(number_format($plan->sms_charge, 2)); ?></td>
                                <td>
                                    <?php if($plan->active): ?>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <?php if(hasRolePermission('savingsPlans-edit')): ?>
                                        <!-- Edit Button (Pencil Icon) -->
                                        <a href="<?php echo e(route('saving.form', $plan->id)); ?>" class="icon green"
            ...
            <div class="card-footer" style="padding: 1%">
                ...
                <div class="footer-info">
                    Total Records : <?php echo e($plans->total()); ?>

                </div>

                <!-- Pagination -->
                <div class="pagination-container">
                    <?php echo e($plans->links('vendor.pagination.custom-pagination')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accountPlan/Savingindex.blade.php ENDPATH**/ ?>