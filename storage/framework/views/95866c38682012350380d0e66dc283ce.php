...
<?php $__env->startSection('title'); ?> DD Account Plans <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center bg-light w-100" style="height: 40px;">
                ...
                <div class="me-2">
                    <a href="<?php echo e(route('dd.form')); ?>" onclick="showLoadingEffect(event)"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <form method="GET" action="<?php echo e(route('dd.index')); ?>" class="d-flex align-items-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        <a href="<?php echo e(route('dd.form', $ddPlan->id)); ?>" class="icon green"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accountPlan/Ddindex.blade.php ENDPATH**/ ?>