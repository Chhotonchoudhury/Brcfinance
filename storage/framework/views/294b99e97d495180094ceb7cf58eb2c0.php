...
<?php $__env->startSection('title'); ?> RD Account Plan Store <?php $__env->stopSection(); ?>
...
<div class="row gutters mb-2">
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">RD plan</li>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('rd.index')); ?>" class="btn btn-sm btn-outline-dark py-1 px-2"
...
<div class="card">
    <form action="<?php echo e(route('rd.save', $plan->id ?? '')); ?>" id="DDstore" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="card-body">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                <div class="form-section-header"><?php if(isset($plan->id)): ?> Update <?php else: ?> Add <?php endif; ?> RD Plan Details</div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u519289329/domains/brcfinance.in/public_html/resources/views/accountPlan/Rdstore.blade.php ENDPATH**/ ?>