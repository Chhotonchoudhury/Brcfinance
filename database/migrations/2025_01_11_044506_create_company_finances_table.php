...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('company_finances', function (Blueprint $table) {
            $table->id();
            $table->decimal('total_deposits', 20, 2)->default(0); // Total deposits in the company
            $table->decimal('total_withdrawals', 20, 2)->default(0); // Total withdrawals in the company
